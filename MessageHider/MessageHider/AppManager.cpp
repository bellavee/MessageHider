...
void AppManager::CreateDecodeElements()
{
    ...
    (
        WS_EX_CLIENTEDGE,
        L"EDIT",
        L"Secret Message extrait avec beaucoup de texte qui va d�passer la taille de la fen�tre pour forcer l apparition d une barre de d�filement...",
...
void AppManager::ShowErrorPopup(const WCHAR* error)
{
    MessageBox(
        ...
        L"Erreur",              // Le titre de la bo�te de dialogue
